...
+ (BookmarkObject *)objectWithDictionary:(NSDictionary *)dictionary {
    ...
    ret.documentId = [[dictionary objectForKey:@"documentId"] intValue];
...
- (NSDictionary *)toDictionary {
    ...
    [ret setObject:[NSString stringWithFormat:@"%d" , documentId] forKey:@"documentId"];
...
- (BOOL)equals:(BookmarkObject *)obj {
    return self.documentId == obj.documentId && self.page == obj.page;
}
