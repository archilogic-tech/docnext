...
public class ThumbnailCreator {
    ...
    protected static final int TEXTURE_BASE_SIZE = 256;
    protected static final int TEXTURE_N_HORIZONATL = 4;
    protected static final int TEXTURE_N_VERTICAL = 6;
    ...
    protected int[] getImageSize( final String path ) {
        final String[] sizes =
    ...
    protected String getPpmPath( final String prefix , final int page ) {
