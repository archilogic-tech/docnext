...
public enum ImageDocDirection {
    ...
    boolean shouldChangeToNext( final PointF offset , final SizeInfo surface , final SizeInfo image , final float scale ) {
        switch ( this ) {
        case L2R:
    ...
    boolean shouldChangeToPrev( final PointF offset , final SizeInfo surface , final SizeInfo image , final float scale ) {
        switch ( this ) {
        case L2R:
            return offset.x > surface.width / PAGE_CHANGE_THREASHOLD;
        case R2L:
    ...
    void updateOffset( final PointF offset , final SizeInfo image , final float scale , final boolean isNext ) {
