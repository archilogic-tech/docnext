...
public class GetImagePageTask extends NetworkTask< Void , Void > {
    private final Receiver< Void , Void > _receiver;
    private final long _id;
    private final int _page;

    public GetImagePageTask( final Context context , final Receiver< Void , Void > receiver , final long id ,
            final int page ) {
        super( context );
    ...
    protected Void background() throws IOException {
        final FileOutputStream out = new FileOutputStream( StorageUtil.getImagePath( _id , _page ) );

        IOUtils.copy( NetUtil.getImagePage( _id , _page ) , out );
